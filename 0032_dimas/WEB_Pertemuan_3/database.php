...
class Database{
    ...
    {
        mysqli_query($this->connect, "INSERT INTO tb_users VALUES (NULL, '$nama', '$alamat', '$nohp', '$jeniskelamin', '$email', '$foto')");
    }
    ...
    {
        mysqli_query($this->connect, "UPDATE `tb_users` SET `nama` = '$nama', `alamat` = '$alamat', `nohp` = '$nohp', `jeniskelamin` = '$jeniskelamin', `email` = '$email', `foto` = '$foto'
